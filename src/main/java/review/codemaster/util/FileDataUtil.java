package review.codemaster.util;
...
public class FileDataUtil {
	...
	private String uploadPath; // 디렉토리 정보. 정보의 값은 주입받도록 코딩.
	// 컨테이너로부터 주입 받는 코드. @Inject, @Resource @Autowired
	...
	@ResponseBody // view의 이름이 아니라 리턴타입에 따라 응답하게 된다.
	// 어떤 데이터를 포함하여 전송.. 어노테이션.. view지정하지 않고 바로 클라이언트 요청으로 응답.
	 ...
	 * @throws IOException
	 */
	// 클라이언트가 업로드한 첨부파일을 지정된 위치(uploadPath)로 카피하는 코드
